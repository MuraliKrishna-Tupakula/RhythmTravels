...
<%
    ...
    if (session.getAttribute("success-admin-login-uname")==null){
        response.sendRedirect("http://localhost:8081/fdlab2/FDLAB2/login.html");
    }
%>
...
<div class="topnav">
    <div class="dropdown">
        <button class="dropbtn"><font color="#0004ff">Login</font>
  ...
  <a href="home7.html">Home</a>
   ...
   <section class="login-form">
        ...
        <form action="http://localhost:8081/Fdlab2/FDLAB2/adminupdate.jsp" method="post">
            <h3>Update User</h3>
            <div class="inputbox">
